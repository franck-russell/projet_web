<?php
    ...
    if (
        ...
        if (
            ...
            $livraisonC->ajouterlivraison($det);
          ...
          <div class="row block-9">
		            ...
		            <div class="col-md-12 mb-3">
		              <p><span>Website:</span> <a href="#">yoursite.com</a></p>
						...
						<button><a href="about.php" class="btn btn-primary">Show my details</a></action>  </button>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Your Adresse" id="adresse" name="adresse">
                            </div>
                            <div class="form-group">
                                    <label for="text" class="form-label">Zip</label>
                                    <input type="text" class="form-control" placeholder="Your zip code" id="zip" name="zip">
                            </div>
                            <div class="mb-3">
