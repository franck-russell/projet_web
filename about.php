<?php
  include_once 'C:/xampp/htdocs/E_Beauty/Controller/DetC.php';
    $detC=new detC();
    $listedets=$detC->afficherdets(); 
      		...
      		<div class="row d-md-flex text-wrapper">
						...
						<div class="one-half half-text d-flex justify-content-end align-items-center">
							<div class="text-inner pl-md-5">
								...
								<button><a href="contact.php" class="btn btn-primary">Ajouter det</a></action>  </button>
                           
						   <center><h1>Liste des dets</h1></center>
				   </div>
